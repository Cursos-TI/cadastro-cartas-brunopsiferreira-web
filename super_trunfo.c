...
int main()
{
  ...
  unsigned long int populacao1; // Nível mestre, convertido para unsigned long int
  // int populacao1;
  float area1;
  float pib1;
  ...
  float densidade1;
  float pibPerCapita1;
  float superPoder1; // Nova variável para calcular o poder da carta
  ...
  // Área para entrada de dados
  unsigned long int populacao2; // Nível mestre, convertido para unsigned long int
  // int populacao2;
  float area2;
  float pib2;
  ...
  float densidade2;
  float pibPerCapita2;
  float superPoder2; // Nova variável para calcular o poder da carta
